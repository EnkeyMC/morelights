...
public class BlockModernWallLamp extends Block{

	public BlockModernWallLamp(int par1, Material par2Material) {
	    ...
	    {
	        {
	            ...
	            {
	                case 2:
	                	this.setBlockBounds(Pix.TWO, Pix.TEN, Pix.TWELVE, Pix.FOURTEEN, Pix.FOURTEEN, Pix.SIXTEEN);
	                	break;
	                case 3:
	                	this.setBlockBounds(Pix.TWO, Pix.TEN, 0.0F, Pix.FOURTEEN, Pix.FOURTEEN, Pix.FOUR);
	                    break;
	                case 4:
	                	this.setBlockBounds(0F, Pix.TEN, Pix.TWO, Pix.FOUR, Pix.FOURTEEN, Pix.FOURTEEN);
	                	break;
	                case 5:
	                	this.setBlockBounds(Pix.TWELVE, Pix.TEN, Pix.TWO, Pix.SIXTEEN, Pix.FOURTEEN, Pix.FOURTEEN);
	                	break;
	                default:
	                	System.out.println("Bad metadata of BlockModernWallLamp!" + meta);
	            }
	        }
	    }
